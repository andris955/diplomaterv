...
from stable_baselines.common import explained_variance, tf_util, ActorCriticRLModel, SetVerbosity
...
class myA2C(ActorCriticRLModel):
    """
    ...
    def __init__(self, policy, env, gamma=0.99, n_steps=5, vf_coef=0.25, ent_coef=0.01, max_grad_norm=0.5,
        ...
        super(myA2C, self).__init__(policy=policy, env=env, verbose=verbose, requires_vec_env=True,
