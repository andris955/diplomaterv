...
def main(algorithm, selected_mti, n_cpus, max_train_steps, uniform_policy_steps, train=True,
...
if __name__ == '__main__':
    main(algorithm='A5C', selected_mti=global_config.MTI1, n_cpus=2, max_train_steps=global_config.MaxTrainSteps,
         uniform_policy_steps=100, train=True, tensorboard_logging=None, transfer_id=None, model_id=global_config.model_id)
