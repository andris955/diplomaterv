...
if __name__ == '__main__':
    ...
    parser.add_argument('--policy', type=str, nargs='?', help='Name of the desired policy can be codt_ff, dodt_ff (feed forward) or dodt_lstm, codt_lstm. Default codt_lstm', default='codt_lstm')
